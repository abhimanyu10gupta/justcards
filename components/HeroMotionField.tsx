...
/* ---------- DEMO CARD IMAGES ---------- */
/* Swap these with your own designs later */
const CARD_IMAGES = [
  'https://i.imgur.com/3ZQ3ZQp.png', // meme-style
  'https://i.imgur.com/8Km9tLL.png', // fake ID
  'https://i.imgur.com/vxXQF6L.png', // bold text card
  'https://i.imgur.com/Qr71crq.png', // minimal
  'https://i.imgur.com/JYwZ5qN.png', // graphic
  'https://i.imgur.com/9yG6F5B.png', // club pass vibe
]
...
export default function HeroMotionField() {
